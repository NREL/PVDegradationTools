# -*- coding: utf-8 -*-
"""
Created on Wed Apr 22 12:09:09 2020

@author: Code written by Derek Holsapple with computational testing by Mike Kempe 
...
surface_temp = processedData_df['Module Temperature(open_rack_cell_glassback)(C)']
...
SDw = relativeHumidity.SDw( So ,  Eas , Ead  , rH_ambient , ambient_temp , surface_temp)
#WVTRo : Water Vapor Transfer Rate prefactor (g/m2/day). The suggested value for EVA is  7970633554(g/m2/day).
WVTRo = 7970633554
#EaWVTR : Water Vapor Transfer Rate activation energy (kJ/mol) . It is suggested to use 0.15(mm) thick PET as a default for the backsheet and set EaWVTR=55.0255(kJ/mol)
EaWVTR = 55.0255
...
RHfrontEncap = pd.Series(name="RHfront" , data= relativeHumidity.RHfront( SDw , So , Eas, surface_temp ) )
