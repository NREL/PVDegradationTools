...
def edge_seal_ingress_rate(average_water_saturation_pressure):
    ...
    Parameters
    ----------
    average_water_saturation_pressure : float
    ...
    """
    k = 0.0013 * (average_water_saturation_pressure) ** 0.4933
...
def edge_seal_width(
    ...
    if k is None:
        water_saturation_pressure, average_water_saturation_pressure = (
            humidity.water_saturation_pressure(temp)
        )
        k = edge_seal_ingress_rate(average_water_saturation_pressure)
