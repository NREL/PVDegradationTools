...
- Replace print messages for failure or successful addition of objects (location, job...)
...
- Deprecate `see_added` argument, and associated UserWarning for successful addition of
