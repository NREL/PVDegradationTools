...
class Scenario:
    ...
    def addJob(
        ...
        # DONT NEED TO DO THIS ANYMORE??? we dont want to save pipeline to the csv lke this because we have the json
...
class Geospatial_Scenario(Scenario):
    def __init__(
        ...
        # email = None, # shouldn't ever need api key for geospatial cases 
        # api_key = None, 
        ):
